...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2023 at 04:46 AM
...
(7, '0000-00-00', 'SHORT BOND PAPER', 6, 'Open', '0000-00-00', '0000-00-00', '0000-00-00');
...
--
-- Table structure for table `supplier_txn`
--

CREATE TABLE `supplier_txn` (
  `id` int(30) NOT NULL,
...
--
-- Indexes for table `supplier_txn`
--
ALTER TABLE `supplier_txn`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `supplier_txn`
--
ALTER TABLE `supplier_txn`
