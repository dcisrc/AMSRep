    ...
    <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <span><b>Supplies Delivery </b></span>
          ...
          <div class="row">
              ...
              <div class="form-group col-md-2" style="padding-left:30px">
                <label>PO No</label>
                <input type="text" name="po_number" id="po_number" required="required" class="form-control text-left" />'
  ...
  <script type="text/javascript">
    ...
    function add_item(){
      ...
      var price = document.getElementById("price").value;
        ...
        if (po_number == ''){
          alert_toast("PO Number required");
          return;
        }
        if (tran_date == '0000-00-00' || tran_date == '' || tran_date == 'mm/dd/yyyy'){
          alert_toast("Transaction Date required");
          return;
        }
        if (item_id == ''){
       ...
       $.ajax({
         url:"getiteminfo.php?id="+item_id+"&qty="+qty+"&price="+price,
         type: 'get',
         dataType: 'html',
