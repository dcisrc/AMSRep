...
function Header()
{
    ...
    $this->SetXY(10,25);
    $this->Cell(200,10,'PROPERTY TRANSFER RECEIPT ',0,0,'C');
    $this->SetFont('Arial','B',10);
    $this->SetXY(10,35);
	...
	$this->SetXY(150,40);
    $this->Cell(40,10,'PAR No: '.$ptrnumber);
    $this->SetXY(10,40);
    $this->Cell(140,10,'From Accountable Officer/Agency/Fund Cluster: ',0,0);
   
    $this->SetXY(150,45);
    $this->Cell(40,10,'Date : ');
    $this->SetXY(10,45);
    $this->Cell(140,10,'To Accountable Officer/Agency/Fund Cluster: ',0,0);
